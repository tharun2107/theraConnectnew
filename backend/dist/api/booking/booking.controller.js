...
const createBookingHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const parentProfile = yield prisma_1.default.parentProfile.findUnique({ where: { userId: req.currentUser.userId } });
        if (!parentProfile)
...
const getMyBookingsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const bookings = yield bookingService.getMyBookings(req.currentUser.userId, req.currentUser.role);
...
const getRecurringBookingsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.currentUser.userId; // Changed from req.currentUser
    ...
    try {
        ...
        if (error instanceof Error) {
            if (error.message.includes('not found')) {
                return res.status(4404).json({ success: false, message: error.message });
            }
