...
class LeaveService {
    ...
    getLeaveBalances(therapistId, leaveDate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const latestLeave = yield prisma.therapistLeave.findFirst({
                where: {
    ...
    hasUsedOptionalThisMonth(therapistId, leaveDate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const optionalLeaveThisMonth = yield prisma.therapistLeave.findFirst({
                where: {
                    therapistId: therapistId,
    ...
    requestLeave(therapistUserId, leaveData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingLeave = yield prisma.therapistLeave.findFirst({
                where: {
    ...
    getAllLeaveRequests(status) {
        return __awaiter(this, void 0, void 0, function* () {
            const leaves = yield prisma.therapistLeave.findMany({
    ...
    getLeaveRequestById(leaveId) {
        return __awaiter(this, void 0, void 0, function* () {
            const leave = yield prisma.therapistLeave.findUnique({
                where: { id: leaveId },
                include: {
                    therapist: {
                        select: {
    ...
    processLeaveRequest(adminUserId, approvalData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // --- REJECTION CASE ---
            if (!isApproved) {
                const rejectedLeave = yield prisma.therapistLeave.update({
                    where: { id: approvalData.leaveId },
            ...
            switch (leave.type) {
                case client_1.LeaveType.CASUAL:
                    newBalances.casualRemaining -= 1;
                    break;
                case client_1.LeaveType.SICK:
                    newBalances.sickRemaining -= 1;
                    break;
                case client_1.LeaveType.FESTIVE:
                    newBalances.festiveRemaining -= 1;
                    break;
                case client_1.LeaveType.OPTIONAL:
                    newBalances.optionalRemaining -= 1;
                    break;
            }
            try {
                updatedLeave = yield prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
            ...
            const therapist = yield prisma.therapistProfile.findFirst({
