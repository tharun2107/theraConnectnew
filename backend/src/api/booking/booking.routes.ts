...
import { getSlotsQuerySchema, createBookingSchema, getRecurringBookingSchema, cancelRecurringBookingSchema } from './booking.validation';
...
router.post('/:bookingId/zoom/create',authorize([Role.THERAPIST]),zoomController.createMeetingForBooking);
