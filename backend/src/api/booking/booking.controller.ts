...
export const createBookingHandler = async (req: Request, res: Response) => {
    try {
        ...
        const parentProfile = await prisma.parentProfile.findUnique({ where: { userId: req.currentUser!.userId }});
...
export const getMyBookingsHandler = async (req: Request, res: Response) => {
    try {
        const bookings = await bookingService.getMyBookings(req.currentUser!.userId, req.currentUser!.role);
